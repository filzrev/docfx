...
public class YamlSerializer
{
    ...
    private IObjectGraphTraversalStrategy CreateTraversalStrategy()
    {
        if (IsOptionSet(SerializationOptions.Roundtrip))
            return new RoundtripObjectGraphTraversalStrategy(Converters, this, _typeDescriptor, _typeResolver, 50, _namingConvention, _settings, _objectFactory);

        return new FullObjectGraphTraversalStrategy(this, _typeDescriptor, _typeResolver, 50, _namingConvention, _objectFactory);
    }

...
class OneOfJsonConverterFactory : JsonConverterFactory
{
    ...
    private class OneOfJsonConverter<T> : JsonConverter<T> where T : IOneOf
    {
        ...
        public override T? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                if (!IsDeserializableType(ref reader, typeToConvert, type))
                    continue;
        ...
        private static bool IsDeserializableType(ref Utf8JsonReader reader, Type typeToConvert, Type type)
        {
            ...
            switch (tokenType)
            {
                case JsonTokenType.String:
                    // OneOf<bool, string>
                    if (typeToConvert == typeof(OneOf<bool, string>) && type == typeof(bool))
                        return false;
                    return true;

                case JsonTokenType.StartArray:
                    // Inline : OneOfBase<Span, Span[]> / OneOf<string, string[]
                    return type.IsArray;
                ...
                case JsonTokenType.StartObject:
                    ...
                    // Unknown type/name combinations.
                    // Return `true` and fallback to default behaviors (Try to deserialize candidate types in sequence)
                    return true;
        ...
        /// <summary>
        /// Known type/name combinations that can deserialize.
        /// </summary>
        ...
        /// <summary>
        /// Known type/name combinations that can not deserialize.
        /// </summary>
